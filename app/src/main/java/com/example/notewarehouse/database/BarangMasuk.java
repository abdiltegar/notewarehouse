...
public class BarangMasuk {
    ...
    public BarangMasuk(int id_arus, int id_user, String kode_barang, String nama_barang, String satuan, String kode_ruangan, String nama_ruangan, int jumlah, String tanggal, boolean apakah_masuk) {
