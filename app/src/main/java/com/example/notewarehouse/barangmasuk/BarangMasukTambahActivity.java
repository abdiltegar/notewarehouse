...
public class BarangMasukTambahActivity extends AppCompatActivity  {
...
//    static String hostname = "http://10.20.14.90";
    ...
    private static String url_insert = hostname+"/ws-notewarehouse/barang_masuk/tambah.php";
    private static final String TAG = BarangMasukTambahActivity.class.getSimpleName();
...
//    String[] ValueRuangans = new String[1];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barang_masuk_tambah);

        etTanggal = findViewById(R.id.etbmTanggal);
        etJumlah = findViewById(R.id.etbmJumlah);

        spinJenisBarang = findViewById(R.id.spinJenisBarang);
        spinRuangan = findViewById(R.id.spinRuangan);

        simpanBtn = findViewById(R.id.btnTambahBarangMasuk);
        batalBtn = findViewById(R.id.btnBatalTambahBarangMasuk);
        ...
        etTanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(BarangMasukTambahActivity.this, date, myCalendar
        ...
        batalBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BarangMasukTambahActivity.this, BarangMasukActivity.class);
    ...
    public void DropDownListJenisBarang(){
        ...
        StringRequest jArr = new StringRequest(url_spinner_jenisbarang, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        ArrayAdapter<String> arrayAdapterBarang = new ArrayAdapter<String>(BarangMasukTambahActivity.this,android.R.layout.simple_spinner_item, TextJenisBarangs);
                        ...
                        Toast.makeText(BarangMasukTambahActivity.this, "Gagal : "+jObj.getString(TAG_MESSAGE), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BarangMasukTambahActivity.this, "gagal", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        ArrayAdapter<String> arrayAdapterRuangan = new ArrayAdapter<String>(BarangMasukTambahActivity.this,android.R.layout.simple_spinner_item, TextRuangans);
    ...
    public void SimpanData(){
        if(etTanggal.getText().toString().equals("") || etJumlah.getText().toString().equals("") || spinJenisBarang.getSelectedItem().toString().equals("") || spinRuangan.getSelectedItem().toString().equals("")){
            Toast.makeText(BarangMasukTambahActivity.this, "Semua harus diisi data", Toast.LENGTH_SHORT).show();
        }else{
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url_insert, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (status) {
                            Toast.makeText(BarangMasukTambahActivity.this, "sukses simpan data", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(BarangMasukTambahActivity.this, BarangMasukActivity.class);
                            startActivity(intent);
                            finish();
                        } else {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(BarangMasukTambahActivity.this, "Gagal simpan data", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
